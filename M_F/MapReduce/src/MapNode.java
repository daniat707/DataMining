...
public class MapNode implements Callable<Map<String, List<Integer>>> {
    ...
    public MapNode(List<String> chunkFiles, String outputFilePath, boolean induceError, boolean reassigned) {
    ...
    public Map<String, List<Integer>> call() throws Exception {
        ...
        if (induceError) {
            System.out.println("\u001B[31mError inducido en el Nodo Map. Fallo en el procesamiento de chunkFiles.\u001B[0m");
            throw new Exception("Nodo Map falló intencionalmente.");
        }

        // Mensaje si es un nodo reasignado
        if (reassigned) {
            System.out.println("\u001B[33mNodo Map reasignado. Procesando chunkFiles...\u001B[0m");
        }
        ...
        System.out.println("MAP Nodo finalizó exitosamente el procesamiento de chunkFiles.");
        return wordCount;
    }
